...
/**
 * An abstract catalog debug.
 */
public abstract class AbstractCatalogDebug implements CatalogDebug {
	// Original text of the debug definition.
	...
	public AbstractCatalogDebug(String originalQuery, String expandedQuery, TableSchema schema,
