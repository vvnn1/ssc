...
SqlCreate SqlCreateDebug(Span s, boolean replace, boolean isTemporary) : {
...
}
{
    ...
    {
        return new SqlCreateDebug(s.pos(), debugName, fieldList, query, replace, isTemporary, ifNotExists, comment, null);
    }
}
...
}
{
    ...
    (
		...
		|
		create = SqlCreateDebug(s, replace, isTemporary)
        |
